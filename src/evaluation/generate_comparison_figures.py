...
SCAFFOLD_PRED = (
    "results/scaffold_densenet121_predictions.csv"
)
...
for df, name in [
    ...
    (scaffold, "SCAFFOLD DenseNet-121")
...
save_confusion_matrix(
    ...
    "SCAFFOLD DenseNet-121 Confusion Matrix",

    f"{OUTPUT_DIR}/confusion_matrix_scaffold.png"
