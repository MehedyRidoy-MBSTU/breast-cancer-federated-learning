...
CHECKPOINT = (
    "checkpoints/densenet121_best.pth"
)
...
print("=" * 70)
print("FINAL TEST EVALUATION - DENSENET-121")
print("=" * 70)
...
print(
    "Best DenseNet-121 checkpoint loaded successfully."
)
...
print("\n" + "=" * 70)
print("FINAL TEST RESULTS - DENSENET-121")
print("=" * 70)
...
print(
    "DENSENET-121 TEST EVALUATION COMPLETED"
)
